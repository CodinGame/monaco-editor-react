...
import { DisposableStore, IReference, ITextFileEditorModel } from '@codingame/monaco-vscode-api/monaco'
import type { ITextFileEditorModelSaveEvent } from '@codingame/monaco-vscode-a17f5129-e16c-5dac-857e-dcd91bfeffa2-common/vscode/vs/workbench/services/textfile/common/textfiles'
